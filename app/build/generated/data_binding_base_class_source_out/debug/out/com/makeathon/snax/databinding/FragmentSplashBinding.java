...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull ConstraintLayout rootView,
      @NonNull Button enterDetailsButton, @NonNull TextView textView) {
    this.rootView = rootView;
    this.enterDetailsButton = enterDetailsButton;
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.enter_details_button;
      Button enterDetailsButton = ViewBindings.findChildViewById(rootView, id);
      if (enterDetailsButton == null) {
        break missingId;
      }
      ...
      return new FragmentSplashBinding((ConstraintLayout) rootView, enterDetailsButton, textView);
    }
